...
export default function Sidebar({ genres }: Props) {
  return (
    <aside className="self-start sticky top-0 max-h-[calc(100vh-78px)] overflow-y-auto p-4 bg-gradient-to-br from-dark-gray to-black/80 rounded-3xl shadow-2xl backdrop-blur-md border border-indigo-500/10 no-scrollbar">
